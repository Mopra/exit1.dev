/**
 * Script to backfill daily summaries for earlier dates.
 */

import { backfillDailySummaries } from '../src/bigquery';

async function main() {
  // Data exists from 2025-11-26 onwards - let's backfill Nov 26 to Jan 5
  const startDate = new Date('2025-11-26');
  const endDate = new Date('2026-01-05');

  console.log(`\n🚀 Starting daily summaries backfill for early dates...`);
