...
/** Tiers that may hide the exit1 branding on badges. Legacy values ('agency', 'scale',
 *  'premium') kept so old cached check docs still resolve correctly before the next recompute. */
const PAID_TIERS = new Set(['indie', 'nano', 'pro', 'agency', 'scale', 'premium']);
